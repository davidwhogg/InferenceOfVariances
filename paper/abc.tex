...
infer everything about the initial conditions (at that scale, see {\it e.g.}, \citealt{peebles}).
...
These were partly successful on specific data sets and problems, 
but don't replace the standard approach due to computational and modelling constraints.
