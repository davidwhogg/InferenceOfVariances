...
mean $\mu=7.0$ and variance $V=17.0$ (units arbitrary).
...
The pseudo-likelihood (\ref{eq:pseudo}) requires the setting of the
variance-of-variance parameter $\Sigma^2$.
To set this, we make use of theory\footnote{\url{https://en.wikipedia.org/wiki/Variance}}
