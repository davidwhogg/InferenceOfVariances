...
For another, it has support at negative variances!
...
over all possible draws of the density field $\rho(x)$),
...
\textbf{Take-home message 1:} \emph{When we infer the correlation function
